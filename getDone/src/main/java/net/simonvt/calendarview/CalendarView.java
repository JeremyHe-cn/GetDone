 ...
 * @attr ref android.R.styleable#CalendarView_selectedDateBackgroundColor
 * @attr ref android.R.styleable#CalendarView_focusedMonthDateColor
 * @attr ref android.R.styleable#CalendarView_unfocusedMonthDateColor
 * @attr ref android.R.styleable#CalendarView_weekNumberColor
 * @attr ref android.R.styleable#CalendarView_weekSeparatorLineColor
 * @attr ref android.R.styleable#CalendarView_selectedDateVerticalBar
 * @attr ref android.R.styleable#CalendarView_selectedDateColor
...
public class CalendarView extends FrameLayout {
    ...
    private int mSelectedDateColor;
    ...
    public CalendarView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mSelectedDateBackgroundColor = attributesArray.getColor(
                R.styleable.CalendarView_cv_selectedDateBackgroundColor, mSelectedWeekBackgroundColor);
        mFocusedMonthDateColor = attributesArray.getColor(
                R.styleable.CalendarView_cv_focusedMonthDateColor, 0);
        mSelectedDateColor = attributesArray.getColor(
        		R.styleable.CalendarView_cv_selectedDateColor, mFocusedMonthDateColor);
    ...
    private class WeekView extends View {
        ...
        private void drawBackground(Canvas canvas) {
            ...
            mTempRect.right = mSelectedRight;
        ...
        private void drawWeekNumbersAndDates(Canvas canvas) {
            ...
            if (isLayoutRtl()) {
                ...
                int selectedIndex = -1;
                if (mHasSelectedDay) {
                	selectedIndex = mSelectedDay-1;
				}
                
                for (; i < nDays; i++) {
                	if (selectedIndex == i) {
                		mMonthNumDrawPaint.setColor(mSelectedDateColor);
					} else {
						mMonthNumDrawPaint.setColor(mFocusDay[i] ? mFocusedMonthDateColor
								: mUnfocusedMonthDateColor);
					}
