...
import com.dateSlider.labeler.Labeler;
import com.dateSlider.timeview.TimeView;
...
public class ScrollLayout extends LinearLayout {
    ...
    public ScrollLayout(Context context, AttributeSet attrs) {
        ...
        rightShadow = getContext().getResources().getDrawable(R.drawable.dateslider_right_shadow);
        leftShadow = getContext().getResources().getDrawable(R.drawable.dateslider_left_shadow);
