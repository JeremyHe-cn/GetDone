...
public class FriendDao extends AbstractDao<Friend, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Device = new Property(3, String.class, "device", false, "DEVICE");
    };
    ...
    public Friend readEntity(Cursor cursor, int offset) {
        Friend entity = new Friend( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3) // device
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Friend entity, int offset) {
        ...
        entity.setDevice(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
     }
