...
public class ArrangeTaskActivity extends BaseActivity implements OnDateChangeListener, OnClickListener, android.widget.RadioGroup.OnCheckedChangeListener {
	...
	public static void navigateToForResult(Activity activity,int requestCode,long arrangeTime){
		Intent intent = new Intent(activity,ArrangeTaskActivity.class);
	...
	private void findView() {
		...
		mTimeContainer = (SliderContainer)findViewById(R.id.arrange_sliderContainer);
	...
	private void initView(){
		...
		// 时间选择器 
		mTimeContainer.setTime(mArrangeDate);
		mTimeContainer.setMinuteInterval(5);
		mTimeContainer.setMinTime(Calendar.getInstance());
	}
